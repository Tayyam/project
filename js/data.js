export const DATA = {
  ...
  roi: {
    intro: "**العائد والاسترداد يُحسبان تلقائياً** من: (1) جدول الإيرادات المجمّع بعد تطبيق نسبة نجاح التدوير و**استثناء عمولة المسوق من إعادة بيع الجهاز**، (2) **OPEX** من `opex.totalMonthly`، (3) **CAPEX** = مجموع أصول `purchases.fixedAssets` بالدولار + بنود `capex.extraItems` (يشمل **3 أشهر من OPEX** كاحتياط تشغيل) + تقدير **مخزون مستورد 3 شهور**. أرقام البطاقات العلوية وشريطي النسبة تتبع هذا النموذج — لا تُحدَّث يدوياً.",
    capex: {
      extraItems: [
