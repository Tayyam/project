export const DATA = {
  ...
  importedConsumablesQuarterly: {
    ...
    note: "Consumables + spare parts only (no long-life tools). Tin stencils + 90×90 platform: **① fixed assets**. Bridge wires here. **معايرة عند 47 عملية/شهر** (`monthlyVolume.totalOperations`) — تركيز ~35 هاشبورد؛ عامل التحميل في الواجهة = عملياتك الحالية ÷ هذا الأساس.",
    baselineMonthlyOperations: 47,
    items: [
      { name: "BM1362 ASIC (Bitmain)", unit: "chip", baseMonthlyQty: 6.27, unitUSD: 3.5, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=1106", planHint: "~35 هاشبورد/شهر + تدوير؛ يُضبط مع نسبة التخليع/شرائح جديدة." },
      { name: "BM1366BS ASIC (S19K Pro)", unit: "chip", baseMonthlyQty: 1.27, unitUSD: 9, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=3202", planHint: "Fewer donors than S19 — keep minimum stock." },
      { name: "KF1950 / KF1958 ASIC (Whatsminer)", unit: "chip", baseMonthlyQty: 3.13, unitUSD: 2, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=1994", planHint: "M30 family." },
      { name: "KF1968 / KF1973 ASIC (Whatsminer)", unit: "chip", baseMonthlyQty: 1.88, unitUSD: 6.65, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=2200", planHint: "M50 / M60 class." },
      { name: "Pre-tinned bridge wires", unit: "~100 pcs 10/15 cm", baseMonthlyQty: 0.22, unitUSD: 1.2, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=2461", planHint: "Consumable — not a fixed asset." },
      { name: "Amtech NC-559-ASM flux", unit: "10g syringe", baseMonthlyQty: 1.88, unitUSD: 8, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=2277" },
      { name: "Mechanic 183°C solder paste", unit: "60g", baseMonthlyQty: 0.63, unitUSD: 12, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=264" },
      { name: "BGA solder balls 0.4mm", unit: "bottle — select size on Zeus", baseMonthlyQty: 0.16, unitUSD: 2, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=1555", planHint: "Order **0.4 mm** + lead-free on product page." },
      { name: "Mechanic UVH900-LY solder mask", unit: "tube", baseMonthlyQty: 1.27, unitUSD: 6.54, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=1585" },
      { name: "HY234 thermal putty", unit: "1 kg", baseMonthlyQty: 0.31, unitUSD: 5, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=1638" },
      { name: "Arctic MX-6 thermal paste", unit: "8 g tube — select on Zeus", baseMonthlyQty: 0.13, unitUSD: 19, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=2835", planHint: "IceRiver hash re-paste (Zeus); also workshop MOS ↔ heatsink vs Bitmain **2500** spec in APW12 mirror." },
      { name: "24-pin data cable", unit: "60 cm", baseMonthlyQty: 13.79, unitUSD: 1.8, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=107", planHint: "بيع كابلات في الجدول المالي ~4/شهر + مخزون تشغيلي." },
      { name: "Control LDO / PMIC kit", unit: "chip", baseMonthlyQty: 16.29, unitUSD: 0.05, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=997", planHint: "مع ~1 إحياء كنترول/شهر — راجع الكمية سنوياً." },
      { name: "SI7N65F MOSFET (PSU)", unit: "chip", baseMonthlyQty: 20.05, unitUSD: 0.4, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=3934", planHint: "مع ~2 باور/شهر — تخزين أقل من خط الأساس 75 عملية." },
      { name: "TPHR9003NL MOSFET (hash)", unit: "chip", baseMonthlyQty: 1.27, unitUSD: 1.2, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=84", planHint: "S19 buck — Zeus MOQ 20; adjust order batch." },
      { name: "PIC16F1704", unit: "chip", baseMonthlyQty: 0.94, unitUSD: 3.5, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=1124", planHint: "هاش S19 (U3) — Zeus MOQ 10." },
      { name: "SMD resistor sample book", unit: "book", baseMonthlyQty: 0.31, unitUSD: 7.75, source: "AliExpress", url: "https://ar.aliexpress.com/item/1005008894523897.html" },
      { name: "SMD capacitor sample book", unit: "book", baseMonthlyQty: 0.31, unitUSD: 12, source: "AliExpress", url: "https://ar.aliexpress.com/item/1005004657585875.html" },
      { name: "Desoldering wick CP-2015", unit: "2.0mm × 1.5m roll", baseMonthlyQty: 0.25, unitUSD: 1.96, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=1870" },
      { name: "Board wash (ultrasonic)", unit: "Mechanic 500 / no-residue", baseMonthlyQty: 0.47, unitUSD: 3.9, source: "Zeus Mining", url: "https://www.zeusbtc.com/ASIC-Miner-Repair/Parts-Tools-Details.asp?ID=1782", planHint: "With ultrasonic — post-repair deep clean." }
    ]
  },

  localConsumablesQuarterly: {
    title: "خطة الطلب ربع السنوية — استهلاكات محلية",
    note: "Local recurring (Attaba / Boustan). **أساس 47 عملية/شهر** مثل `monthlyVolume.totalOperations`. لوحة تخليع ~1.07/شهر → ~3–4/ربع × 1500 ج. مرواح البنش + أسلاك الجسر: خطة الاستيراد. مرتبة حسب تكلفة الربع (عالي → منخفض).",
    baselineMonthlyOperations: 47,
    currency: "EGP",
    items: [
      { name: "Donor hashboard (parts harvesting)", unit: "board (~76 ASIC)", baseMonthlyQty: 1.07, unitEGP: 1500, source: "Local scrap", planHint: "Selective strip + test; new chips stay on import plan." },
      { name: "IPA 99%", unit: "500 ml bottle", baseMonthlyQty: 0.75, unitEGP: 220, source: "Attaba / chemicals" },
      { name: "IPA 99% spray", unit: "large spray — hash rinse", baseMonthlyQty: 0.56, unitEGP: 320, source: "Attaba / chemicals" },
      { name: "GD900 (or equiv.)", unit: "thermal paste", baseMonthlyQty: 0.63, unitEGP: 250, source: "Attaba / Boustan" },
      { name: "Kapton + aluminum tape", unit: "hot-air shielding", baseMonthlyQty: 0.63, unitEGP: 80, source: "Attaba" },
      { name: "Metal-tip syringes", unit: "~10 pcs", baseMonthlyQty: 0.38, unitEGP: 45, source: "Pharmacy / local" },
      { name: "Silicone cable clips", unit: "desk routing", baseMonthlyQty: 0.21, unitEGP: 95, source: "PC accessories" }
    ]
  },
