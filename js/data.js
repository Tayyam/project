export const DATA = {
  ...
  workflow: [
    ...
    },
    {
      ...
      description: "**منصة تسخين سفلية** متساوية للسطح + **هواء ساخن**؛ فلاكس مناسب ومعجون لحام؛ **قناع UV** عند الحاجة. توازن بين **شرائح Zeus جديدة** و**تخليج** من لوحات مانحة محلياً — راجع خطة المستورد/المحلي ربع السنوية."
    },
    {
      step: "07",
